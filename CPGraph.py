...
#Posizione File
png_output_directory = "D:\\Dynamis\\Script\\FotoScript\\CPGraph\\"
casefoam = OpenFOAMReader(FileName='D:\\Dynamis\\CFD\\DPX\\case.foam')

#Posizione Camera
renderView1.CameraPosition = [-0.72, -13.5, 0.07]
renderView1.CameraFocalPoint = [-0.72, -0.02, 0.07]
renderView1.CameraViewUp = [0, 0, 1]
renderView1.InteractionMode = '2D'
renderView1.AxesGrid = 'GridAxes3DActor'
renderView1.OrientationAxesVisibility = 0
renderView1.CenterOfRotation = [0.5546321868896484, -0.02, -0.75]
renderView1.StereoType = 'Crystal Eyes'
renderView1.CameraPosition = [0.5066759179790631, -6.716466354884856, 0.7663098486245471]
renderView1.CameraFocalPoint = [0.5066759179790631, -0.3737813765765168, 0.7663098486245471]
renderView1.CameraFocalDisk = 1.0
renderView1.CameraParallelScale = 0.9266447327932037

trasp = 0 #mettere 1 per sfondo trasparente, 0 altrimenti

# Posizione e tipo di Slice
y_pt = numpy.around(numpy.arange(-0.7, 0, 0.02), decimals=2)
...
## Apertura file
casefoam.MeshRegions = ['boundingBox1', 'boundingBox2', 'boundingBox3', 'boundingBox4', 'boundingBox5', 'boundingBox6', 'internalMesh', 'solid_0_Diffuser', 'solid_0_FW', 'solid_0_Front_Wheels', 'solid_0_Monocoque', 'solid_0_Motoruote', 'solid_0_Paratie', 'solid_0_RW', 'solid_0_Rear_Wheels', 'solid_0_Sidewings', 'solid_0_UnderTray']
...
extractBlock1.BlockIndices = [9, 18, 16, 14, 17, 15, 12, 13, 10, 11]
